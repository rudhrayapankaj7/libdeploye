...
# exec(open('C:\\Users\\rudhr\\OneDrive\\Desktop\\pankaj_library\\Library\\Library\\Book\\db_shell.py').read())
# ORM Queries
...
# books = Book.objects.all().filter(id__in=l).values_list("price" , "name")
# print(books)
...
# objs = (Book.objects.filter(id__in=[36,37,38]))
# print (objs)
